...
Expand synthetic API/UI coverage and run the production migration only after the agent releases its lock; then restore its prior running state and complete final verification/push.
