...
Add safe document lookups, status-specific workflow/stepper UI, skip/retry and sequential batch orchestration; then expand synthetic coverage and run the production migration protocol.
