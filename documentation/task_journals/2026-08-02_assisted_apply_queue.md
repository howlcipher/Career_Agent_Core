...
Add missing synthetic API/UI coverage and audit every requirement against the current implementation before the final backlog close, journal removal, push, and merge.
