...
Implement authoritative leases, action transitions, confirmation provenance, and a visible single-job assisted browser command; then wire those actions into the dashboard.
