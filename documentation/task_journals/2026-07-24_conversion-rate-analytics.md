...
Delegate to `agy -p "<brief>" --model gemini-3.1-pro-high --mode accept-edits --print-timeout 30m`, then review the diff, run build/vet/test, and verify live before committing.
