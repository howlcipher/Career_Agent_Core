...
**This resolves the open question of `documentation/task_journals/2026-07-21_verify-bug4-iframe-fill-live-batch.md`.** The historical `APPLIED` rows were not genuine, and the cause was never an inability to fill forms: the pipeline submitted without being able to detect that it had (#95, #102, #111), and could not complete the out-of-band code challenge (#113, #115, #116).
