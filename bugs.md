...
- [x] `go test ./...` passes for every package that has tests — **re-verified 2026-07-27 after #127:** all packages green; the focused race suite for permission repair, storage, tracker, agent, and dashboard also passes.
...
- [ ] Zero open bugs below tagged `Blocker` or `Major` in the Ranked Backlog — **7 remain after #127 was resolved on 2026-07-27.** The application sweep filed #118-#129 and reopened the unresolved half of #112. The earlier 2026-07-24 evidence remains valid historically, but the gate is now open again.
...
**Status after #127 resolution: UNMET.** Build, vet and the full test suite are clean, but 7 open Blocker/Major defects remain. Bug work continues to outrank `improvements.md`.
