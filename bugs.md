...
- [x] `go test ./...` passes for every package that has tests — **re-verified 2026-07-26 after #118:** all packages green, including the six previously failing submitter scenarios and five focused resume-upload regression tests.
...
**Status after #118 resolution on 2026-07-26: UNMET.** Build, vet and the full test suite are clean again, but the sweep still has open Blocker/Major defects. Bug work continues to outrank `improvements.md`.
