...
- [ ] Zero open bugs below tagged `Blocker` or `Major` in the Ranked Backlog — **1 remains as of 2026-07-28.** The application sweep filed #118-#129 and reopened the unresolved half of #112. The earlier 2026-07-24 evidence remains valid historically, but the gate is now open again.
