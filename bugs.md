...
- [x] `go test ./...` passes for every package that has tests — **re-verified 2026-07-26 after #119:** all packages green, including the new no-SerpApi free-discovery regression.
...
**Status after #119 resolution and the 2026-07-26 groom: UNMET.** Build, vet and the full test suite are clean, but 11 open Blocker/Major defects remain. Bug work continues to outrank `improvements.md`.
