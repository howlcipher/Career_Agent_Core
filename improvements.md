...
**2026-08-01, session forty-one.** Improvement #506 is Done: `/work_next_item` now combines open, above-floor Minor bugs and improvements when the Usability Gate is `MET`, instead of silently starving `bugs.md`. Its first next selection is bug #501 (2.0), ahead of improvement #491 (1.5). See `documentation/backlog_history/improvements_done_details.md` item #506 for the full account. Prior status paragraph archived to `documentation/backlog_history/improvements_groom_history.md`.
