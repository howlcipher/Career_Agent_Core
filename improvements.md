...
| 511 | [Assisted Apply Queue with resumable human handoff and legacy-job backfill](#511-assisted-apply-queue-with-resumable-human-handoff-and-legacy-job-backfill) | Pending | 1.0 (8×1.0÷8) | deep-reasoning | User-selected 2026-08-02: safe human completion avoids losing prepared applications while preserving explicit confirmation. |
